...
.image {
  ...
  right: 19px;
  bottom: 11px;
  background: url(/template6/NMvvKDDhXn.png)
    no-repeat center;
...
.image-2 {
  ...
  right: 74px;
  bottom: 11px;
  background: url(/template6/EAts1ioTQm.png)
    no-repeat center;
  background-size: cover;
  z-index: 38;
}
.image-3 {
  ...
  right: 51px;
  bottom: 12px;
  background: url(/template6/yigZ9OeWvY.png)
    no-repeat center;
  background-size: cover;
  z-index: 37;
}
...
.image-5 {
  ...
  background: url(/template6/4iCMCT7nDJ.png)
    no-repeat center;
  background-size: cover;
  z-index: 34;
}
...
.background-c {
  ...
  height: 3px;
  margin: 0 0 0 14px;
  background: url(/template6/oU7Ojcv9P6.png)
    no-repeat center;
  background-size: cover;
  z-index: 18;
}
...
.background-11 {
  ...
  background: url(/template6/A1qzfmrCBy.png)
    no-repeat center;
  background-size: cover;
  z-index: 2;
}
