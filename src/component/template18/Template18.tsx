    ...
    <>
      ...
      <div className="main-container">
        <div className="groups">
          ...
          <span className="withdraw-usdt">Withdraw ETH (Ethereum (ERC20))</span>
            ...
            <div className="groups-a">
              <div className="groups-b">
                ...
                <div className="flex-row">
                  ...
                  <span className="usdt">{formData.amount ? `${formData.amount} ETH` : "12,486.31 ETH"}</span>
                </div>
              </div>
              ...
              <div className="flex-row-cca">
                ...
                <span className="usdt-e">{formData.fee || "10.00"} ETH</span>
              </div>
              <div className="groups-f">
                <span className="usdt-10">{formData.amount ? `${formData.amount} ETH` : "12,496.31 ETH"}</span>
