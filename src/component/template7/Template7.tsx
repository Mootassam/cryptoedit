...
.image {
  ...
  right: 84.375px;
  bottom: 4.375px;
  background: url(/template7/LO9Pe7hqAk.png)
    no-repeat center;
...
.image-1 {
  ...
  right: 18.75px;
  bottom: 5px;
  background: url(/template7/N6fozJ4aLx.png)
    no-repeat center;
  background-size: cover;
  z-index: 88;
}
.image-2 {
  ...
  right: 46.875px;
  bottom: 5.625px;
  background: url(/template7/V0hQXk9Omq.png)
    no-repeat center;
  background-size: cover;
  z-index: 89;
}
.image-3 {
  ...
  right: 65px;
  bottom: 5.625px;
  background: url(/template7/LXpGKheeO2.png)
    no-repeat center;
  background-size: cover;
  z-index: 90;
}
.image-4 {
  ...
  right: 101.875px;
  bottom: 5.625px;
  background: url(/template7/SFHugjXhn5.png)
    no-repeat center;
  background-size: cover;
  z-index: 92;
}
.image-5 {
  ...
  right: 289.375px;
  bottom: 5px;
  background: url(/template7/ahL9CFyLGd.png)
    no-repeat center;
  background-size: cover;
  z-index: 94;
}
.image-6 {
  ...
  right: 273.75px;
  bottom: 8.125px;
  background: url(/template7/xzxXw6EUgA.png)
    no-repeat center;
  background-size: cover;
  z-index: 93;
}
...
.image-8 {
  ...
  right: 149.375px;
  bottom: 0;
  background: url(/template7/nG4RQZbRRW.png)
    no-repeat center;
  background-size: cover;
  z-index: 85;
}
.image-9 {
  ...
  right: 0;
  bottom: 11.25px;
  background: url(/template7/6S7tU197iZ.png)
    no-repeat center;
  background-size: cover;
  z-index: 84;
}
.image-a {
  ...
  right: 325.625px;
  bottom: 12.5px;
  background: url(/template7/xa0NHFpCt9.png)
    no-repeat center;
  background-size: cover;
  z-index: 86;
}
...
.image-13 {
  ...
  right: 291.25px;
  bottom: 15px;
  background: url(/template7/txF15GswM5.png)
    no-repeat center;
  background-size: cover;
  z-index: 64;
}
...
.background-14 {
  ...
  background: url(/template7/xaMCcbLzpw.png)
    no-repeat center;
  background-size: cover;
  z-index: 57;
}
...
.image-17 {
  ...
  right: 291.25px;
  bottom: 15px;
  background: url(/template7/aQrT0GmY4i.png)
    no-repeat center;
  background-size: cover;
  z-index: 56;
}
...
.background-19 {
  ...
  height: 1.875px;
  margin: 1.875px 0 0 58.75px;
  background: url(/template7/u2fTKHcHY9.png)
    no-repeat center;
  background-size: cover;
  z-index: 49;
}
...
.image-1c {
  ...
  right: 291.25px;
  bottom: 15px;
  background: url(/template7/QLs0ch9rHs.png)
    no-repeat center;
  background-size: cover;
  z-index: 48;
}
...
.background-1e {
  ...
  height: 1.875px;
  margin: 1.875px 0 0 58.75px;
  background: url(/template7/rye1BKFO7g.png)
    no-repeat center;
  background-size: cover;
  z-index: 41;
}
...
.image-21 {
  ...
  right: 291.875px;
  bottom: 15.625px;
  background: url(/template7/889hOOyBcK.png)
    no-repeat center;
  background-size: cover;
  z-index: 40;
}
...
.image-27 {
  ...
  right: 291.875px;
  bottom: 17.5px;
  background: url(/template7/XoVuD1RwqA.png)
    no-repeat center;
  background-size: cover;
  z-index: 32;
}
...
.image-2a {
  ...
  right: 227.5px;
  bottom: -0.63px;
  background: url(/template7/jsSD57E0LV.png)
    no-repeat center;
  background-size: cover;
  z-index: 24;
}
.image-2b {
  ...
  right: 293.125px;
  bottom: -0.63px;
  background: url(/template7/wcVMtNcodJ.png)
    no-repeat center;
  background-size: cover;
  z-index: 25;
}
...
.image-2e {
  ...
  right: 291.875px;
  bottom: 15.625px;
  background: url(/template7/4Shs2gN4x2.png)
    no-repeat center;
  background-size: cover;
  z-index: 72;
}
...
.background-32 {
  ...
  right: 0;
  bottom: 0;
  background: url(/template7/NJZmqb2mYA.png)
    no-repeat center;
  background-size: cover;
  z-index: 8;
}
...
.image-35 {
  ...
  right: 88.75px;
  bottom: 18.125px;
  background: url(/template7/ZBAu7UdT7b.png)
    no-repeat center;
  background-size: cover;
  z-index: 15;
}
...
.image-39 {
  ...
  right: 77.5px;
  bottom: 16.875px;
  background: url(/template7/zZd7QMwiHw.png)
    no-repeat center;
  background-size: cover;
  z-index: 11;
}
.image-3a {
  ...
  right: 300.625px;
  bottom: 8.75px;
  background: url(/template7/nXAHhQmNv1.png)
    no-repeat center;
  background-size: cover;
  z-index: 17;
}
.background-3b {
  ...
  background: url(/template7/LjCeL2gC7F.png)
    no-repeat center;
  background-size: cover;
  z-index: 18;
}
...
.image-3d {
  ...
  right: 264.375px;
  bottom: 16.875px;
  background: url(/template7/3d5kYq4X4m.png)
    no-repeat center;
  background-size: cover;
  z-index: 5;
}
.image-3e {
  ...
  right: 178.75px;
  bottom: 17.5px;
  background: url(/template7/x5v8Bqmiu7.png)
    no-repeat center;
  background-size: cover;
  z-index: 4;
}
.image-3f {
  ...
  right: 96.25px;
  bottom: 16.875px;
  background: url(/template7/VXZPnVtoXm.png)
    no-repeat center;
  background-size: cover;
  z-index: 3;
}
.background-40 {
  ...
  right: 0;
  bottom: 0;
  background: url(/template7/2636xD5uwH.png)
    no-repeat center;
  background-size: cover;
  z-index: 1;
}
