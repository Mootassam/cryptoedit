...
.image {
  ...
  height: 18.125px;
  margin: 0 0 0 0;
  background: url(https://codia-f2c.s3.us-west-1.amazonaws.com/image/2026-03-30/8Qnv2RNFk2.png)
    no-repeat center;
...
.image-5 {
  ...
  background: url(https://codia-f2c.s3.us-west-1.amazonaws.com/image/2026-03-30/f0KgnrPDuU.png)
    no-repeat center;
  background-size: cover;
  z-index: 18;
}
...
.image-a {
  ...
  right: 288.75px;
  bottom: 0;
  background: url('https://codia-f2c.s3.us-west-1.amazonaws.com/image/2026-03-30/ZrWWeExejc.png')
    no-repeat center;
  background-size: cover;
  z-index: 3;
}
...
.image-d {
  ...
  right: 21.875px;
  bottom: 21.25px;
  background: url(https://codia-f2c.s3.us-west-1.amazonaws.com/image/2026-03-30/whDie95cR4.png)
    no-repeat center;
  background-size: cover;
  z-index: 38;
}
.image-e {
  ...
  right: 459.375px;
  bottom: 23.75px;
  background: url(https://codia-f2c.s3.us-west-1.amazonaws.com/image/2026-03-30/RUrRkdeW6m.png)
    no-repeat center;
  background-size: cover;
  z-index: 40;
}
...
.image-11 {
  ...
  width: 20.625px;
  height: 21.25px;
  background: url(https://codia-f2c.s3.us-west-1.amazonaws.com/image/2026-03-30/6CHSM2iqWw.png)
    no-repeat center;
  background-size: cover;
  z-index: 35;
}
          ...
          <div className="groups">
            <div className="groups-1">
              ...
              <div className="groups-7">
                ...
                <span className="ousdt">OUSDT</span>
              </div>
              ...
              <div className="groups-9">
                <span className="time-stamp">2026-03-2410:27:53</span>
